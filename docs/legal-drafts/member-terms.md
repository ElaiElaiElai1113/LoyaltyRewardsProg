...
Operator: `[LEGAL ENTITY NAME, ADDRESS, AND REGISTRATION DETAILS REQUIRED]`  
Support contact: `[WORKING SUPPORT EMAIL REQUIRED]`
...
Rewards arise only from eligible, recorded transactions with participating businesses. Offers may vary by business, membership plan, location, inventory, dates, and verification status. Rewards are not cash, deposits, investments, or guaranteed income and cannot be sold or transferred unless a published offer expressly permits it.
...
Accounts may be restricted for security, fraud prevention, legal compliance, or material breach. The final policy must define notice, appeal, remaining rewards, data retention, and treatment of paid membership after termination.

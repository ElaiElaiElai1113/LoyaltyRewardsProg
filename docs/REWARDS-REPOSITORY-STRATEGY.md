...
- Medellín, RewardMe, Guatemala, and Wondertown use the same tested application,
...
| RewardMe | Flagship Philippines tenant | This repository, tenant hostname/configuration |
...
Clone or add `LoyaltyRewardsProg` once. RewardMe and Wondertown do not appear as

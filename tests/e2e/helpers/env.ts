...
export const e2ePassword = process.env.E2E_PASSWORD ?? readDotEnvValue('E2E_PASSWORD') ?? 'Rewards 123!'
...
const lifecycleAuthRequested =
  ...
  process.env.npm_lifecycle_event === 'test:e2e:rewardme-safe' ||
  process.env.npm_lifecycle_event === 'test:tenant-security' ||

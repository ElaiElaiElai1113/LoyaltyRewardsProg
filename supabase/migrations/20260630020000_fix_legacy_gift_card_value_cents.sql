...
begin
  if exists (
    ...
    set gift_card_value_cents = coalesce(gift_card_value_cents, 0);

    alter table public.gift_cards
      alter column gift_card_value_cents set default 0,
    ...
    execute $sql$
      ...
      begin
        ...
        if new.gift_card_value_cents is null then
          ...
          new.gift_card_value_cents := coalesce(round(parsed_value * 100)::integer, 0);
        end if;

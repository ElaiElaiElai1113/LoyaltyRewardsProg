...
const spanishTranslations: Record<string, string> = {
  ...
  Admin: 'Administrador',
  Business: 'Negocio',
  'Platform administration': 'AdministraciÃ³n de plataforma',
  'Owners and staff': 'DueÃ±os y personal',
  'Rewards members': 'Miembros de recompensas',
  'Sign in as {role}': 'Iniciar sesiÃ³n como {role}',
  'Choose your account type. Your assigned role is verified when you sign in.':
    'Elige tu tipo de cuenta. Verificamos tu rol asignado al iniciar sesiÃ³n.',
...
const tagalogTranslations: Record<string, string> = {
  ...
  'Sign in': 'Mag-sign in',
  'Sign In': 'Mag-sign in',
  'Platform administration': 'Pamamahala ng platform',
  'Owners and staff': 'Mga may-ari at staff',
  'Rewards members': 'Mga miyembro ng rewards',
  'Sign in as {role}': 'Mag-sign in bilang {role}',
  'Choose your account type. Your assigned role is verified when you sign in.':
    'Piliin ang uri ng account. Beripikado ang nakatalagang role kapag nag-sign in ka.',

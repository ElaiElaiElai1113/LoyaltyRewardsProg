    ...
    <div className="space-y-16 pb-20">
      <div className="flex flex-col gap-12 lg:flex-row lg:items-start lg:justify-between">
        <div className="space-y-6 max-w-2xl">
          <Badge variant="ritual" className="bg-secondary-container/20 text-secondary">
            Your Narrative
          </Badge>
          ...
          <p className="text-lg leading-relaxed text-on-surface-variant/60 font-medium italic">
            "Your balance stays front and center, while rewards, promotions, and recent visits remain easy to scan in one premium workspace."
          </p>
        </div>
      ...
      <section className="relative overflow-hidden rounded-3xl bg-primary-container p-10 md:p-16 text-white shadow-ritual">
        <div className="absolute top-0 right-0 w-1/3 h-full bg-gradient-to-l from-white/5 to-transparent pointer-events-none" />
        <div className="relative z-10 grid gap-12 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-10">
            <div className="space-y-2">
              <span className="text-[0.7rem] font-bold uppercase tracking-[0.3em] text-white/40">Available Balance</span>
              <div className="flex items-baseline gap-4">
                <span className="font-serif text-7xl md:text-9xl tracking-tighter leading-none">
                  {formatPoints(balance?.points ?? 0)}
                </span>
                <span className="text-xl md:text-2xl font-medium text-white/40 italic">Reserved Points</span>
              </div>
            </div>
            
            <div className="space-y-4 max-w-md">
              <div className="flex justify-between items-end">
                <span className="text-sm font-bold uppercase tracking-widest text-white/60">{profile?.tier} Tier Status</span>
              ...
              <p className="text-sm text-white/40 font-medium leading-relaxed">
                Just {formatPoints(Math.max((balance?.nextRewardPoints ?? 0) - (balance?.points ?? 0), 0))} points away from your next artisanal unlock.
              </p>
            </div>
          </div>
      ...
      <div className="grid gap-20 lg:grid-cols-[1fr_400px]">
        ...
        <div className="space-y-10">
          <div className="flex items-end justify-between border-b border-outline-variant/10 pb-6">
            <div className="space-y-2">
              <span className="text-[0.65rem] font-bold uppercase tracking-[0.2em] text-on-surface-variant/40">Curated</span>
        ...
        <div className="space-y-10">
          <div className="flex items-end justify-between border-b border-outline-variant/10 pb-6">
             <div className="space-y-2">
              <span className="text-[0.65rem] font-bold uppercase tracking-[0.2em] text-on-surface-variant/40">Limited</span>
      ...
      <section className="space-y-10 bg-surface-low -mx-6 px-6 py-20 rounded-[3rem]">
        <div className="mx-auto max-w-5xl space-y-10">
          <div className="flex items-end justify-between border-b border-outline-variant/10 pb-6">
            <div className="space-y-2">
              <span className="text-[0.65rem] font-bold uppercase tracking-[0.2em] text-on-surface-variant/40">Chronicle</span>

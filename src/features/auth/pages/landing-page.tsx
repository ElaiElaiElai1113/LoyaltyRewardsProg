  ...
  return (
    <div className="min-h-screen px-4 py-8 md:px-8 lg:px-12 bg-surface">
      <div className="mx-auto grid min-h-[calc(100vh-6rem)] max-w-7xl gap-12 lg:grid-cols-[1.2fr_0.8fr]">
        <section className="relative overflow-hidden rounded-[3rem] bg-primary px-8 py-16 md:px-16 md:py-24 text-white shadow-ritual flex flex-col justify-between">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(255,255,255,0.1),transparent)] opacity-50" />
          
          <div className="relative z-10 space-y-12">
            <Badge variant="ritual" className="bg-white/10 text-white border-white/20 px-6 py-2">
              Authentic Roast & Ritual
            </Badge>
            <div className="max-w-3xl space-y-8">
              ...
              <p className="max-w-xl text-xl font-medium leading-relaxed text-white/70">
                A high-integrity rewards collective for the discerning enthusiast. Experience presence, resonance, and artisanal offerings.
              </p>
            </div>
              ...
              {[
                {
                  icon: Coffee,
                  title: 'Presence',
                  body: 'A calm, dashboard view of your journey.',
                },
                {
                  icon: Gift,
                  title: 'Resonance',
                  body: 'Polished rewards for your presence.',
                },
                {
                  icon: ShieldCheck,
                  title: 'Management',
                  body: 'Staff tools for curation and flow.',
                },
              ].map((item) => (
          ...
          <div className="relative z-10 mt-16 rounded-[2.5rem] bg-white/5 p-8 backdrop-blur-md border border-white/10">
            ...
            <p className="mt-6 text-xs font-medium text-white/40 italic">
              Experience the ritual with pre-authenticated resonance.
            </p>
          </div>
        </section>
              ...
              <div className="space-y-10">
                <div className="space-y-2 text-center">
                  ...
                  <p className="text-sm font-medium text-on-surface-variant/40">
                    Checking balance or resuming management rituals.
                  </p>
                </div>
                ...
                <div className="mx-auto max-w-md rounded-[2.5rem] bg-surface-low p-10 border border-outline-variant/10">
                  ...
                  >
                    <div className="grid gap-3">
                      ...
                      <Input id="signin-email" placeholder="ritual@velvetbrew.co" {...signInForm.register('email')} />
                    </div>

                    <div className="grid gap-3">
                      <Label htmlFor="signin-password">Secret Ritual Code</Label>
                    ...
                    >
                      {signInForm.formState.isSubmitting ? 'Opening Conduit...' : 'Enter the Sanctuary'}
                    </Button>
                  </form>
                </div>
              </div>
            ...
            <TabsContent value="signup" className="outline-none">
              <div className="space-y-10">
                <div className="space-y-2 text-center">
                  ...
                  <p className="text-sm font-medium text-on-surface-variant/40">
                    A new membership for artisanal experiences.
                  </p>
                </div>
                ...
                <div className="mx-auto max-w-md rounded-[2.5rem] bg-surface-low p-10 border border-outline-variant/10">
                  ...
                  >
                    <div className="grid gap-3">
                      ...
                      <Input id="signup-name" placeholder="Artisan Name" {...signUpForm.register('fullName')} />
                    </div>

                    <div className="grid gap-3">
                      <Label htmlFor="signup-email">Email Address</Label>
                      <Input id="signup-email" placeholder="ritual@velvetbrew.co" {...signUpForm.register('email')} />
                    </div>

                    <div className="grid gap-3">
                      <Label htmlFor="signup-password">Secret Ritual Code</Label>
                    ...
                    >
                      {signUpForm.formState.isSubmitting ? 'Manifesting Identity...' : 'Initiate Ritual'}
                    </Button>
                  </form>
                </div>
              </div>

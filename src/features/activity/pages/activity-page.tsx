    ...
    <div className="space-y-16 pb-20">
      <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between border-b border-outline-variant/10 pb-12">
        ...
        <div className="flex flex-col items-start gap-4 lg:items-end">
          ...
          <div className="rounded-2xl bg-surface-low px-6 py-4 text-primary shadow-card flex items-center gap-4 border border-outline-variant/10">
             <div className="size-10 rounded-full bg-primary flex items-center justify-center">
                <Wallet className="size-5 text-secondary-container" />
             </div>
             <div className="flex flex-col">
                <span className="font-display text-2xl leading-none">{rewardBalance.data?.points ?? 0}</span>
      ...
      <div className="space-y-8">
        <div className="flex items-end justify-between border-b border-outline-variant/5 pb-4">
          <h2 className="font-display text-3xl text-primary">{t('Timeline')}</h2>
